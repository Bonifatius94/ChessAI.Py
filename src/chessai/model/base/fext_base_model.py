...
class ChessFeatureExtractionModel(tf.keras.Model):
    ...
    def __init__(self, params: dict):
        ...
        self.nn_conv_2 = Conv2D(64, (5, 5), strides=1, padding='same', activation='relu')
                                #kernel_regularizer=L1L2(l1=params['l1_penalty'], l2=params['l2_penalty']))
        self.nn_conv_3 = Conv2D(32, (5, 5), strides=1, padding='same', activation='relu')
                                #kernel_regularizer=L1L2(l1=params['l1_penalty'], l2=params['l2_penalty']))
        self.nn_conv_4 = Conv2D(32, (3, 3), strides=1, padding='same', activation='relu')
                                #kernel_regularizer=L1L2(l1=params['l1_penalty'], l2=params['l2_penalty']))
